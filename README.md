...
- **Situation** – 상황  
    ...
    ***Docker의 기본 개념과 실습 명령어를 학습하고, CLI 실습 중심으로 진행된 개별 시험 응시***  
    *(Notion 문서: 01-Docker, 02-Docker 학습 완료)*

- **Task** – 과제  
Docker 환경과 이미지/컨테이너의 구조 및 동작 원리를 이해하고,  
기본 명령어를 활용해 컨테이너 생성·실행·삭제 등을 실습한 후,  
시험을 통해 CLI 명령 실행 능력을 평가
        ...
        6. 컨테이너 기반 웹 서버 실행 실습
        7. CLI 기반 Docker 시험 응시
...
직접 실습하며 Docker 컨테이너 기반 웹 서버를 구축
        ...
        6. 시험에서 주어진 컨테이너 설정 문제를 명령어로 해결
...
- **Result** – 결과  
        ...
        4. 시험에서 실습 중심 문제를 안정적으로 해결
        5. Docker를 활용한 서비스 배포의 기초 역량 확보
